...
このアプリはSafariの拡張機能についかしてアダルトコンテンツのwebサイト訪問をブロックする機能nの構築
ユーザーはiphoneで設定→safari→拡張機能からrewireのアプリのオンオフの機能をつけて、ネットサーフィンにおけるアダルトコンテンツのブロックを行う機能を実装したい。

アダルトコンテンツのブロックにあたり、ユーザー側が対応すべきことを記したチュートリルも作成してください


claude --resume bbc399e9-9d6a-43a8-8a30-ef6ebe162089   